...
it ('should correctly format UTC dates', () => {
	...
	assert.equal( format.UTC("F j, Y, g:i a", date), "July 14, 2005, 10:30 pm" )
	...
	assert.equal( format.UTC('h-i-s, j-m-y, it is w Day', date), "10-30-41, 14-07-05, 3031 3041 4 Thupm05" )
	assert.equal( format.UTC("D M j G:i:s Y", date), "Thu Jul 14 22:30:41 2005" )
	assert.equal( format.UTC("H:i:s", date), "22:30:41" )
})
